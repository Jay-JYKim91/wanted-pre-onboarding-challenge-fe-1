  ...
  return (
    <div className="max-w-xs md:max-w-lg mx-auto my-8">
      ...
      <div className="pt-20 flex">
          ...
          {todos.map((todo: TodoProps) => {
            return (
              <li
                ...
                // className=`{border p-1 text-white cursor-pointer}`
                // "border p-1 text-white cursor-pointer" + (activeTodoId === todo.id ? `bg-primary-900 text-bold` : ` bg-primary-500`)
              >
                {todo.title}
              </li>
            )
        ...
        <div className="basis-2/3 p-2">hey</div>
      </div>
    </div>
  )
}
