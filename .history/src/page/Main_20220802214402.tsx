...
function Main({ todos, setTodos }: Props) {
  ...
  // useEffect(() => {
  //   if (!activeTodoId && window.localStorage.getItem("activeTodoId")) {
  //     // setActiveTodoId(window.localStorage.getItem("activeTodoId")!)
  //     navigate(`/${window.localStorage.getItem("activeTodoId")!}`)
  //   }

  //   // console.log(window.localStorage.getItem("activeTodoId"))
  // }, [])
    ...
    <div className="max-w-xs md:max-w-lg mx-auto my-8">
      ...
      >
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="p-2 my-4 mr-2 rounded bg-primary-900 text-white shadow-lg"
          >
            <MdLibraryAdd />
          </button>
          <button
            type="submit"
            className="p-2 my-4 rounded bg-primary-900 text-white shadow-lg"
          >
            <MdOutlineEditOff />
          </button>
        </div>
