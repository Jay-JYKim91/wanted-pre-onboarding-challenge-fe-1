    ...
    <div className="max-w-xs md:max-w-lg mx-auto my-8">
      ...
      >
        ...
        <div className="flex justify-end text-xl">
          <button
            type="submit"
            className="p-1 my-4 mr-1 rrounded bg-primary-900 text-white shadow-lg"
          ...
          <button
            type="submit"
            className="p-1 my-4 ounded bg-primary-900 text-white shadow-lg"
          >
            <MdLibraryAdd />
          </button>
        </div>
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <input
                  ...
                  className="border hidden text-2xl px-1 max-w-[130px]"
                />
